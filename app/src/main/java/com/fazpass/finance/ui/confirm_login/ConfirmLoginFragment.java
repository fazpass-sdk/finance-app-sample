...
public class ConfirmLoginFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View backBtn = v.findViewById(R.id.back_btn);
        ...
        cdNotifBtn.setOnClickListener(view -> mViewModel.successLogin());//mViewModel.crossDeviceNotificationOption());

        Button smsVerBtn = v.findViewById(R.id.sms_ver_btn);
        smsVerBtn.setOnClickListener(view -> mViewModel.successLogin());//mViewModel.smsVerificationOption());
